                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST" accept-charset="UTF-8"
                        ...
                        <div class="form-group mb-4">
                            ...
                            <img class="card-img-top"  id="portrait"  src="" style="display:none;" alt="{{ $user->name }}">
                        @if($user->avatar)
                                <br>
{{--               上面的是上传前的照片   这行是上传后的照片<img class="thumbnail img-responsive" src="{{ $user->avatar }}" width="200"/>--}}
                            @endif
                        </div>
